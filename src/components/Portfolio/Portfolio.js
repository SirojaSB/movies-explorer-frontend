    ...
    return (
        <section className='portfolio'>
            ...
            <ul className='portfolio__projects'>
                ...
                <li className='portfolio__project'>
                    <a className='portfolio__link' href="https://github.com/SirojaSB/mario-pizza" target='_blank' rel="noreferrer">
                        <h4 className='portfolio__link-title'>Сайт по заказу пиццы</h4>
                        <img className='portfolio__link-img' src={icon} alt="Иконка ссылка"/>
                    </a>
                </li>
                <li className='portfolio__project'>
