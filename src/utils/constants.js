...
export const WITHOUT_SEARCH_MESSAGE = 'Введите в поиск ключевое слово для поиска интересующего вас фильма.'
export const NOT_FOUND_SAVED_MOVIES_MESSAGE = 'У вас нет сохраненных фильмов'

export const DESKTOP_COMPONENT_SIZE = 1262
export const TABLET_COMPONENT_SIZE = 750
